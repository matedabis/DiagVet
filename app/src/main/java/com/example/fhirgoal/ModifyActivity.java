...
//        titleEditText.setText(userName);
...
//        passwordConfirmEditText.setText(password);
    ...
    public void modify(View view) {
        ...
        map.put("dueDate", due);
//        Dictionary data = {"text": title, "description": detail, "lifecycleStatus": status, "category": category, "dueDate": due};
//        System.out.println(mFirestore.collection("Items").document(itemId).toString());
